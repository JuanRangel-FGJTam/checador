...
function handleNewElementClick(){
    router.visit( route('admin.catalogs.departments.create'));
}
...
<template>
    ...
    <Head title="Catalogo Departamentos" />
                    ...
                    <template v-if="data">
                        <tr v-for="item in data" :key="item.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="p-2 text-center">
                                {{ item.subdirectorate.name}}
                            </td>
                            <td class="p-2 text-center">
                                <NavLink class="px-2 py-0.5 rounded" :href="route('admin.catalogs.departments.edit', item.id)">
                                    Editar
                                </NavLink>
                            </td>
                        </tr>
