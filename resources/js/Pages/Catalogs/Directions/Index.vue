...
function handleNewElementClick(){
    router.visit( route('admin.catalogs.directions.create'));
}
...
<template>
    ...
    <Head title="Catalogo Direccion General" />
                    ...
                    <template v-if="data">
                        <tr v-for="item in data" :key="item.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="p-2 text-center">
                                {{ item.general_direction.abbreviation}}
                            </td>
                            <td class="p-2 text-center">
                                <NavLink class="px-2 py-0.5 rounded" :href="route('admin.catalogs.directions.edit', item.id)">
                                    Editar
                                </NavLink>
                            </td>
                        </tr>
